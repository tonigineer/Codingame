...
| [`games/ultimate-ttt/`](games/ultimate-ttt/) | Ultimate Tic-Tac-Toe on the `common` traits — playable in the terminal vs a baseline bot |
...
just ultimate-ttt        # play in the terminal vs a baseline bot
